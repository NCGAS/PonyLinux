...
say "I am the princess's personal psychotherapist pony, here at your service! Describe to me how you feel today."  2>/dev/null
...
say "Type...'I feel great', or 'I feel sad'" 2>/dev/null
...
say "That's great. Tell me more! Do you feel like...'I learned a lot from the lesson and feel like a master!'? Type Y"  2>/dev/null
else
echo "I am sorry to hear that. Why do you feel this way? Do you feel like...'Linux is hard and I wanna cry'? Type N"
say "I am sorry to hear that. Why do you feel this way? Do you feel like...'Linux is hard and I wanna cry'? Type N"  2>/dev/null
fi
...
say "Why do you feel this way? Type...'It was so easy, even my grandpa could do it'"  2>/dev/null
else
echo "Why do you feel like it is hard? Type...'I do not get what is going on'"
say "Why do you feel like it is hard? Type...'I do not get what is going on'"  2>/dev/null
fi
...
say "Interesting...I am glad you feel so confident! I think you got the hang of this, so we're done! type 'q' to quit."  2>/dev/null
else
echo "You are not a failure, keep trying! Go back over the lesson, and maybe that will help. type 'QUIT' to quit."
say "You are not a failure, keep trying! Go back over the lesson, and maybe that will help. type 'QUIT' to quit."  2>/dev/null
fi
...
say "Goodbye and see you next time!"  2>/dev/null
else
echo "Keep your head up! You've got this. Come back anytime."
say "Keep your head up! You've got this. Come back anytime."  2>/dev/null
fi