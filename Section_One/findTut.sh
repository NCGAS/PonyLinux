...
ponygo twilacorn "If you need to seach for something that has a literal * in the name, you can \"escape\" the star, or tell ${b}find${r} to take it literally, with a backslash in front of it. Like so:${n}${b}find . -name \"\*bucks*\"${r}${n2}This will find *bucks but not any other file that happens to end with \"bucks\"."
