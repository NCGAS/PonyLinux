...
joust="You walk into the training grounds, and the jousting area catches your attention. You see a display of wooden practice swords, sand sacks, and a ball pit. You decide to pick a fight with the practice dummy. You take a sand sack and throw it at the dummy. If that wasn't enough, you decide to take a sword and charge at the dummy, and with a flourish with your sword, body slam it into the ball pit. You feel accomplished."
